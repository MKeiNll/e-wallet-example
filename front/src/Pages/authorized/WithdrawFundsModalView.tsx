...
const WithdrawFundsModalView: React.FC<IProps> = (props: IProps) => {
    ...
    return (
        <>
            ...
            >
                {t("walletsPage.withdrawFundsButtonLabel")}
            </Button>
            <Modal open={open} onClose={handleClose}>
                <div className={classes.paper}>
                    <div>
                        <h3>{t("walletsPage.withdrawFundsModal.title")}</h3>
                    </div>
                    <div>
                        <b> {t("walletsPage.withdrawFundsModal.amountLabel")}</b>
                    </div>
                    <TextField
                    ...
                    <div>
                        <Button variant="contained" color="primary" onClick={withdrawFunds}>
                            {t("walletsPage.withdrawFundsModal.submitButtonLabel")}
                        </Button>
                    </div>
                </div>
            </Modal>
